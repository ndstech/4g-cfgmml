...
type Enbcnoprsvdpara struct {
	XMLName xml.Name `xml:"ENBCNOPRSVDPARA"`
	ATTRIBUTES EnbcnoprsvdparaAttributes `xml:"attributes"`
}

type EnbcnoprsvdparaAttributes struct {
