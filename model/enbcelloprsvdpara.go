...
type Enbcelloprsvdpara struct {
	XMLName xml.Name `xml:"eNBCellOpRsvdPara"`
	ATTRIBUTES EnbcelloprsvdparaAttributes `xml:"attributes"`
}

type EnbcelloprsvdparaAttributes struct {
